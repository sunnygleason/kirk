...
public class ExtendedNCSARequestLog extends AbstractLifeCycle implements RequestLog
{
    ...
    public void log(Request request, Response response)
    {
        try
        {
            ...
            buf.append(' ');
            if (response.getHeader("X-User-ID") != null) {
                buf.append(response.getHeader("X-User-ID"));
            } else {
                buf.append("-");
            }

            buf.append(' ');
            if (response.getHeader("X-Session-ID") != null) {
                buf.append(response.getHeader("X-Session-ID"));
            } else {
                buf.append("-");
            }
            ...
            if (response.getHeader("X-Request-ID") != null) {
                buf.append(response.getHeader("X-Request-ID"));
            } else {
                buf.append("-");
            }
